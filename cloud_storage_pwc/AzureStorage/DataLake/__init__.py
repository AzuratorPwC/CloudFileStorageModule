...
class DataLake(StorageAccountVirtualClass):
    ...
    def read_csv_bytes(self, input_bytes: bytes, engine: ENGINE_TYPES='pandas', encoding: ENCODING_TYPES="UTF-8", delimiter: str=',', is_first_row_as_header: bool=False, skip_rows: int=0, skip_blank_lines=True, quoting: str=None):
        
        df = super().read_csv_bytes(input_bytes=input_bytes, engine=engine, encoding=encoding, delimiter=delimiter, is_first_row_as_header=is_first_row_as_header, skip_rows=skip_rows, skip_blank_lines=skip_blank_lines, quoting=quoting)
    ...
    def read_csv_folder(self,container_name:str,directory_path:str,engine: ENGINE_TYPES = 'polars',encoding:ENCODING_TYPES = "UTF-8", delimiter:str = ",",is_first_row_as_header:bool = False,skip_rows:int=0,skip_blank_lines=True,quoting:str=None,tech_columns:bool=False,recursive:bool=False):
        ...
        df = super().read_csv_folder(container_name = container_name, directory_path = directory_path, engine = engine,encoding = encoding, delimiter = delimiter,is_first_row_as_header = is_first_row_as_header,skip_rows = skip_rows,skip_blank_lines = skip_blank_lines,quoting = quoting,tech_columns = tech_columns,recursive = recursive)
    ...
    def save_dataframe_as_csv(self, df, container_name: str, directory_path: str, file_name: str = None, partition_columns: list = None, encoding: ENCODING_TYPES = "UTF-8", delimiter: str = ";", is_first_row_as_header: bool = True, quoting: str = None, escape: str = None, engine: ENGINE_TYPES = 'polars', replace_to_empty="Default"):
        ...
        result = super().save_dataframe_as_csv(df, container_name, directory_path, file_name, partition_columns, encoding, delimiter, is_first_row_as_header, quoting, escape, engine, replace_to_empty)
    ...
    def read_excel_file(self, container_name: str, directory_path: str, file_name: str, engine: ENGINE_TYPES ='polars', skip_rows: int = 0, is_first_row_as_header: bool = False, sheets=None, is_check_sheet_exist: bool = False, tech_columns: bool = False):
        ...
        result = super().read_excel_file(container_name, directory_path, file_name, engine, skip_rows, is_first_row_as_header, sheets, is_check_sheet_exist, tech_columns)
    ...
    def save_dataframe_as_parquet(self, df, container_name: str, directory_path: str, engine: ENGINE_TYPES ='polars', partition_columns: list = None, compression: COMPRESSION_TYPES = None):
        ...
        super().save_dataframe_as_parquet(df, container_name, directory_path, engine, partition_columns, compression)
    ...
    def read_parquet_file(self, container_name: str, directory_path: str, file_name: str, engine: ENGINE_TYPES = 'polars', columns: list = None, tech_columns: bool = False):
        ...
        df = super().read_parquet_file(container_name, directory_path, file_name, engine, columns, tech_columns)
    ...
    def read_parquet_folder(self, container_name: str, directory_path: str, engine: ENGINE_TYPES = 'polars', columns: list = None, tech_columns: bool = False, recursive: bool = False):
        ...
        df = super().read_parquet_folder(container_name, directory_path, engine, columns, tech_columns, recursive)
               
        return df

    def read_parquet_bytes(self, input_bytes: bytes, engine: ENGINE_TYPES = 'pandas', columns: list = None):
        
        df = super().read_parquet_bytes(input_bytes, engine, columns)
    ...
    def save_json_file(self, df, container_name: str, directory_path: str, file_name: str = None, engine: ENGINE_TYPES ='polars', orient: ORIENT_TYPES = 'records'):
        ...
        super().save_json_file(df, container_name, directory_path, file_name, engine, orient)

    def read_json_bytes(self, input_bytes: bytes, orient: ORIENT_TYPES = 'records', engine: ENGINE_TYPES ='pandas', encoding: ENCODING_TYPES = "UTF-8", quoting: str = None):

        df = super().read_json_bytes(input_bytes, orient, engine, encoding, quoting)
    ...
    def read_json_folder(self, container_name: str, directory_path: str, orient: ORIENT_TYPES = 'records',
        ...
        df = super().read_json_folder(container_name, directory_path, orient, engine, encoding, quoting, tech_columns, recursive)
    ...
    def read_csv_file(self, container_name: str, directory_path: str, file_name: str,
                      ...
                      skip_rows: int = 0, skip_blank_lines: bool = True, quoting: str = None, tech_columns: bool = False):

        df = super().read_csv_file(container_name, directory_path, file_name, engine, encoding, delimiter,
                                   is_first_row_as_header, skip_rows, skip_blank_lines, quoting, tech_columns)
        
        return df
    
    def read_json_file(self, container_name: str, directory_path: str, file_name: str, orient: ORIENT_TYPES = 'records',
                      engine: ENGINE_TYPES = 'polars', encoding: ENCODING_TYPES = "UTF-8", quoting: str = None,
                      tech_columns: bool = False):

        df = super().read_json_file(container_name, directory_path, file_name, orient, engine, encoding, quoting, tech_columns)
